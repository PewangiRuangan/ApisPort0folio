        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
             Seorang lulusan jurusan rekayasa perangkat lunak yang berfokus pada pengembangan web. Saya memiliki pengalaman dalam mengembangkan aplikasi web yang responsif dan fungsional, serta memiliki pemahaman yang kuat tentang teknologi web modern. 
             Saya selalu berusaha untuk terus belajar dan meningkatkan keterampilan saya dalam bidang ini.
            </p>
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Leveraging AI as a professional tool, not a replacement."
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1te2Vs7sXfpEK_1huimKHMOgHxeiz81ty/view?usp=drive_link" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
